...
#define _CPU_H_ 1
  ...
  #include "STC8F.h"
  #define FOSC 24000000L
  #define SYSTEM_TIME_USE   0   /*0,1,2,3,4 for STC8F*/
#elif defined STC8G
  #include "STC8xxxx.h"
  #define FOSC 30000000L
  #define SYSTEM_TIME_USE   0   /*0,1,2,3,4 for STC8G*/
#elif defined STC8H
  #include "STC8xxxx.h"
  #define FOSC 40000000L
  #define SYSTEM_TIME_USE   0   /*0,1,2,3,4 for STC8H*/
