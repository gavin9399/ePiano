...
----------------------------------------------*/
#ifdef STC8G
    #define TOUCH_KEY_QUANTIY          13   /*1~14*/

    #define TOUCH_KEY0_ADC  10
    #define TOUCH_KEY1_ADC  11
    #define TOUCH_KEY2_ADC  12
    #define TOUCH_KEY3_ADC  13
    #define TOUCH_KEY4_ADC  14
    #define TOUCH_KEY5_ADC  0
    #define TOUCH_KEY6_ADC  7
    #define TOUCH_KEY7_ADC  6
    #define TOUCH_KEY8_ADC  5
    #define TOUCH_KEY9_ADC  4
    #define TOUCH_KEY10_ADC  3
    #define TOUCH_KEY11_ADC  2
    #define TOUCH_KEY12_ADC  1
