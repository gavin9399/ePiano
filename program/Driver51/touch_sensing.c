...
void TouchSensingInitialization(void)
{
	...
	adc.ADC_AdjResult = ADC_RIGHT_JUSTIFIED;	//ADC结果调整,	ADC_LEFT_JUSTIFIED,ADC_RIGHT_JUSTIFIED
	adc.ADC_Priority = Priority_0;			//优先级设置	Priority_0,Priority_1,Priority_2,Priority_3
